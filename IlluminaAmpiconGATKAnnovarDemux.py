...
#Library="Amplicon_Library_Details.xlsx"
#Coverage="20X.csv"
#Folder="/home/jibin/Desktop/IlluminaAmpliconDemux/Annovar/"
...
#Sample details
S_Details=pd.read_excel("Amplicon_Library_Details.xlsx",sheet_name="Sample_Details")
...
#Sample details
M_fILE=pd.read_excel("Amplicon_Library_Details.xlsx",sheet_name="Amplicon_Library_Distribution")
...
def greetings(sample_id):
        ...
        #If the above annovar df not contain df 
                ...
                if not Selected_AnnovarDf.empty:
                    ...
                    M_fILE_temp=M_fILE[(M_fILE['#chrom']==chr) & (M_fILE['Start']>=start) & \
                                     (M_fILE['End']<=end)]
